package pl.sdacademy.java.advance.exercises.extras.task2;
...
class Task2Test {
    ...
    void shouldReturnCorrectListForPointA() {
        ...
        //then
        assertThat(result).containsExactlyInAnyOrder(programmer2, programmer4, programmer6);
    }
    ...
    void shouldReturnCorrectListForPointE() {
        ...
        //then
        assertThat(result).containsExactlyInAnyOrder("ccc", "ggg", "kkk");
    }
